...
\label{cha:experiments}
    ...
    \section{CUP} % (fold)
        ...
        Of course, as for the Monk dataset, we have performed a validation phase on the CUP dataset, in order to discover the best parameter for the network. As described in Sec.\ref{sec:monks}, has been implemented, \textit{3-fold cross validation algorithm} with a (random) \textit{grid search}.  Tab. \ref{tab:hyper_cup} shows the ranges in which the searching of the hyperparameters has been carried out.
                ...
                \begin{subtable}{\textwidth}
                    \resizebox{\textwidth}{!}{
                        \begin{tabular}{| c | c | c | c | c | c | c | c |}
                            ...
                            & MSE (TR - TS) \\
                            \hline
                            SGD & 10 -> 16 -> 32 -> 2 & batch & identity & 0.084 & 0.79 & 0.0009 & 0.83 - 1.66 \\
                            \hline
                        \end{tabular}
                    }
                \end{subtable}
                ...
                \begin{subtable}{\textwidth}
                    \resizebox{\textwidth}{!}{
                        \begin{tabular}{| c | c | c | c | c | c | c | c |}
                            ...
                            & MSE (TR - TS) \\
                            \hline
                            $MHS^+$ & 10 -> -> 16 -> 32 -> 2& batch & identity & 0.0001 & 0.27 & 0.29 & 0.7 - 1.18\\
                            \hline
