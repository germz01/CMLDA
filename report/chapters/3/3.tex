...
\label{cha:experiments}
    ...
    \label{sec:monks}
        ...
        In Tab. \ref{tab:hyper_monk} are reported the ranges for the hyperparameters involved in the validation
        phase, while Tab \ref{tab:additional_monks_sgd} and Tab \ref{tab:additional_monks_cgd} provide some
        additional statistics about the convergence for, respectively, the SGD and the CG.
