    ...
    \label{sec:monks}
        ...
        \label{sub:results_for_stochastic_gradient_descent}
            ...
            \begin{table}[H]
                ...
                \begin{subtable}{\textwidth}
                    \resizebox{\textwidth}{!}{
                        \begin{tabular}{| c | c | c | c | c | c | c | c | c |}
                            \hline
                            Task & Topology & Batch size & Activation & $\eta$ & $\alpha$ & $\lambda$ & MSE (TR -
                            TS) &
                            Accuracy (TR - TS) (\%) \\
                            \hline
                            MONK 1 & 17 -> 4 -> 8 -> 1 & batch & sigmoid & 0.61 & 0.83 & 0.0 & 0.0058 - 0.026 &
                            100 \% - 95 \% \\
                            \hline
                            MONK 2 & 17 -> 4 -> 8 -> 1 & batch & sigmoid & 0.64 & 0.78 & 0.0
                            & 0.00092 - 0.015 &
                            100 \% - 97 \% \\
                            \hline
                ...
                \end{subtable}
                \caption{Results for the Stochastic Gradient Descent. In order to obtain this results we used
                the Nesterov's momentum.}
                \label{monks}
    \end{table}
