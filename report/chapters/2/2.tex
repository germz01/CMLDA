...
%deeplearning
		...
		Otherwise, relaxing this assumption in presence of a convex problem, the convergence rate becomes $O(\frac{1}{\sqrt[]{k}})$\cite{Goodfellow-et-al-2016, Montavon-2012,Bottou:1999:OLS:304710.304720}.
...
%new quasi newton method for unconstrain-wei
		...
		\label{sub:line_search}
			...
			The algorithm satisfing the Strong Wolfe conditions is implemented through the functions described in the pseudocodes \ref{alg:linesearch}, \ref{alg:zoom} and is based on the the algorithms presented in \cite{book:92811}.
