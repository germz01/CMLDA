        ...
        \label{sec:stochastic_gradient_descent}
            ...
            \begin{figure}[H]
                ...
                \begin{subfigure}{0.40\textwidth}
                    \resizebox{\textwidth}{!}{
                        \includegraphics{img/comparisons/1_mse_momentum.pdf}
                    }
                    \caption{}
                ...
                \begin{subfigure}{0.40\textwidth}
                    \resizebox{\textwidth}{!}{
                        \includegraphics{img/comparisons/1_accuracy_momentum.pdf}
                    }
                    \caption{}
                ...
                \begin{subfigure}{0.40\textwidth}
                    \resizebox{\textwidth}{!}{
                        \includegraphics{img/comparisons/1_norm_momentum.pdf}
                    }
                    \caption{}
            ...
            \end{figure}
             ...
             \begin{figure}[H]
                ...
                \begin{subfigure}{0.40\textwidth}
                    \resizebox{\textwidth}{!}{
                        \includegraphics{img/comparisons/2_mse_momentum.pdf}
                    }
                    \caption{}
                ...
                \begin{subfigure}{0.40\textwidth}
                    \resizebox{\textwidth}{!}{
                        \includegraphics{img/comparisons/2_accuracy_momentum.pdf}
                    }
                    \caption{}
                ...
                \begin{subfigure}{0.40\textwidth}
                    \resizebox{\textwidth}{!}{
                        \includegraphics{img/comparisons/2_norm_momentum.pdf}
                    }
                    \caption{}
            ...
            \begin{figure}[H]
                ...
                \begin{subfigure}{0.40\textwidth}
                    \resizebox{\textwidth}{!}{
                        \includegraphics{img/comparisons/3_mse_momentum.pdf}
                    }
                    \caption{}
                ...
                \begin{subfigure}{0.40\textwidth}
                    \resizebox{\textwidth}{!}{
                        \includegraphics{img/comparisons/3_accuracy_momentum.pdf}
                    }
                    \caption{}
                ...
                \begin{subfigure}{0.40\textwidth}
                    \resizebox{\textwidth}{!}{
                        \includegraphics{img/comparisons/3_norm_momentum.pdf}
                    }
                    \caption{}
         ...
         \label{sec:conjugate_gradient_methods}
            ...
            \begin{figure}[H]
                ...
                \begin{subfigure}{0.4\textwidth}
                    \resizebox{\textwidth}{!}{
                        \includegraphics{img/comparisons/1_mse_beta.pdf}
                    }
                    \caption{}
                ...
                \begin{subfigure}{0.4\textwidth}
                    \resizebox{\textwidth}{!}{
                        \includegraphics{img/comparisons/1_accuracy_beta.pdf}
                    }
                    \caption{}
                ...
                \begin{subfigure}{0.4\textwidth}
                    \resizebox{\textwidth}{!}{
                        \includegraphics{img/comparisons/1_norm_beta.pdf}
                    }
                    \caption{}
            ...
            \end{figure}
             ...
             \begin{figure}[H]
                ...
                \begin{subfigure}{0.40\textwidth}
                    \resizebox{\textwidth}{!}{
                        \includegraphics{img/comparisons/2_mse_beta.pdf}
                    }
                    \caption{}
                ...
                \begin{subfigure}{0.40\textwidth}
                    \resizebox{\textwidth}{!}{
                        \includegraphics{img/comparisons/2_accuracy_beta.pdf}
                    }
                    \caption{}
                ...
                \begin{subfigure}{0.40\textwidth}
                    \resizebox{\textwidth}{!}{
                        \includegraphics{img/comparisons/2_norm_beta.pdf}
                    }
                    \caption{}
            ...
            \begin{figure}[H]
                ...
                \begin{subfigure}{0.40\textwidth}
                    \resizebox{\textwidth}{!}{
                        \includegraphics{img/comparisons/3_mse_beta.pdf}
                    }
                    \caption{}
                ...
                \begin{subfigure}{0.40\textwidth}
                    \resizebox{\textwidth}{!}{
                        \includegraphics{img/comparisons/3_accuracy_beta.pdf}
                    }
                    \caption{}
                ...
                \begin{subfigure}{0.40\textwidth}
                    \resizebox{\textwidth}{!}{
                        \includegraphics{img/comparisons/3_norm_beta.pdf}
                    }
                    \caption{}
